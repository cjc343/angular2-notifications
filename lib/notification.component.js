...
var NotificationComponent = (function () {
    ...
    NotificationComponent.prototype._remove = function () {
        ...
        if (this.animate) {
            ...
            setTimeout(function () { return _this._service.set(_this.item, false); }, 200);
        }
        else
        ...
        core_1.Component({
            ...
            animations: [
                core_1.trigger("enterLeave", [
                    core_1.state("enter", core_1.style({ opacity: 1, transform: "translateX(0)" })),
                    core_1.transition("* => enter", [
                        core_1.style({ opacity: 0, transform: "translateX(5%)" }),
                        core_1.animate(200)
                    ]),
                    core_1.state("leave", core_1.style({ opacity: 0, transform: "translateX(-5%)" })),
